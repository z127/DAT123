...
public class HourDataItem extends StatisDataItem
{

	// Log log = LogFactory.getLog(HourDataItem.class);
	private final static long HOUR_INTERVAL_ITEM = 60 * 60 * 1000;
	private final static long HOUR_INTERVAL = 24 * HOUR_INTERVAL_ITEM;
	...
	public HourDataItem(long t0, int num)
	{
		super(t0, num, HOUR_INTERVAL, HOUR_INTERVAL_ITEM);
	}

	public HourDataItem(long t0)
	{
		super(t0, 24, HOUR_INTERVAL, HOUR_INTERVAL_ITEM);
	}
			...
			throws IOException
	{
		...
		dos.write(channelid + "_" + "Hour" + "_" + this.stime);
		dos.write("#");
	...
	{
		this.itemStime = di.getT0() - (di.getT0() % HOUR_INTERVAL_ITEM);
		this.itemEtime = this.itemStime + HOUR_INTERVAL_ITEM;
	}
